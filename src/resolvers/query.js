module.exports = {
  ...
  noteFeed: async (parent, { cursor }, { models }) => {
    ...
    // this will pull in the newest notes from the database.
    let cursorQuery = {};
    ...
    // find the limit + 1 of notes in our database, sorted
    // newest to oldest.
    ...
    // set hasNextPage to ture and trim the notes to the limit
